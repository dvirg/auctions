...
from experiment_compare_sbb_shufled_stock import experiment

results_file = "results/experiment_sbb_with_vectors_of_ones_stock_shuffled"

for num_of_seller_categories in (2,4,8,16):
    num_of_categories = num_of_seller_categories+1
    experiment(results_file + str(num_of_categories) + '.csv',
